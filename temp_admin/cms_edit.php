                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link nav-link-lg message-toggle beep"><i class="far fa-envelope"></i></a>
                        <div class="dropdown-menu dropdown-list dropdown-menu-right">
                            ...
                            <?php
                            $result = $edit->getComplains("SELECT * FROM cms_complains INNER JOIN cms_challan on cms_complains.user_id = cms_challan.license_number LIMIT 10");
            ...
            <nav class="navbar navbar-secondary navbar-expand-lg">
                <div class="container">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="#" data-toggle="dropdown" class="nav-link"><i class="fas fa-comments"></i><span> Comments </span></a>
                        </li>
                        <li class="nav-item">
