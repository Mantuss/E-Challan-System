        ...
        <div class="main-wrapper container">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            ...
                            <div class="d-sm-none d-lg-inline-block">Hi, <?php echo $history->getNameTraffic()['firstname'] . " " . $history->getNameTraffic()['lastname']; ?></div>
                        </a>
            ...
            <div class="main-content">
                ...
                <form method="post">
                    ...
                    $traffic_id = $_SESSION['islogged'];
                    if(!empty($searched)){
                        $result = $history->getHistory("SELECT DISTINCT license_number  FROM cms_challan where license_number = '$searched' AND traffic_id ='$traffic_id'");
                    }

                    else{
                        $result = $history->getHistory("SELECT DISTINCT license_number FROM cms_challan WHERE traffic_id ='$traffic_id'");
                    }
