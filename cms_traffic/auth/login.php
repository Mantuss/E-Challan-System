...
class Login
{
    ...
    private function checkDatabase()
    {
        ...
        $sql = "SELECT COUNT(DISTINCT traffic_id) as count From cms_traffic WHERE traffic_id = '$this->traffic_id' AND traffic_pass = '$encrypted' AND account_status = '1' ";
...
if (isset($_POST['submit'])) {
    ...
    $login->logUser();
    $error_status = "Oops! Invalid Login Credintials";
    $color_status = "danger";
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 pt-5 mt-5">
            ...
            <div class="card-header d-flex justify-content-center"><img src="../../dist/assets/img/avatar/E-challan.png" width="200" height="80"></div>
              <!-- <div class="card-header d-flex justify-content-center"><h2>Echallan</h2></div> -->
              ...
              ?>
                ...
                <form method="POST" class="needs-validation" novalidate="">
                  <div class="form-group">
                    ...
                    <input id="email" type="email" class="form-control" name="id" tabindex="1" required autofocus>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="d-block">
                        ...
                        <a href="http://localhost/cms/cms_traffic/auth/recovery.php" class="text-small">
                          Forgot Password?
                        </a>
                      </div>
                    </div>
