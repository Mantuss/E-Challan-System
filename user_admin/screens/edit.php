...
class EditProfile{
  ...
  function getAccounts($tid){
      ...
      $sql = "SELECT * FROM `traffic_logs` WHERE traffic_id = '$tid' ";
  ...
  function updateStatus($tid, $status){
     ...
     $sql = "UPDATE `traffic_logs` SET `account_status`='$status' WHERE traffic_id = '$tid'";
  ...
  function updateDetails($firstname, $lastname, $email, $phone, $address, $state, $zip, $traffic){
    ...
    if($row = $result->fetch_assoc()){
        ...
        $query = "UPDATE `traffic_logs` SET `traffic_id`='$traffic',`firstname`='$firstname',`email`='$email',`number`='$phone',`address`='$address',`state`='$state',`zip_code`='$zip',`lastname`='$lastname' WHERE indicator = '$indi'";
...
if(isset($_POST['save'])){
    ...
    $bool = $updateDetails->updateDetails($_POST['firstname'],$_POST['lastname'],$_POST['email'],$_POST['phone'],$_POST['address'], $_POST['state'],$_POST['zip'],$_POST['traffic']);
    if($bool){
...
if(isset($_POST['status'])){
    ...
    $result = $update->getAccounts($_POST['traffic']);
    $row = mysqli_fetch_array($result);

    if($row['account_status'] == 1){

      $bool = $update->updateStatus($_POST['traffic'], 0);
      ...
      if($bool){
        ...
        $bool = $update->updateStatus($_POST['traffic'], 1);
                    ...
                    <div class="col-md-12">
                      ...
                      <?php
                        if(!empty($active_status)):
                          ...
                          echo "
                          <div class='alert alert-".$active_status_color." alert-dismissible' role='alert'>
                            ".$active_status."
                      ...
                      <div class="card mb-4">
                        ...
                        <!-- Account -->
                        <div class="card-body">
                          <a href="http://localhost/E-Challan/user_admin/screens/manage_accounts.php">
                        ...
                        <?php
                          ...
                          if(isset($_POST['tid'])){
                            ...
                            $result = $create->getAccounts($_POST['tid']);
                            $row = mysqli_fetch_array($result);
                          ...
                          if(isset($_POST['traffic'])){
                            ...
                            $create = new EditProfile();
                            $result = $create->getAccounts($_POST['traffic']);
                            $row = mysqli_fetch_array($result);
                          ...
                          <form id="formAccountSettings" method="POST" action="edit.php">
                            <div class="row">
                              ...
                              <div class="mb-3 col-md-6">
                                ...
                                <input
                                  ...
                                  placeholder="Raymon@example.com"
                                />
                              </div>
                              ...
                              <div class="mb-3 col-md-6">
                                ...
                                <select id="country" name ="state" class="select2 form-select">
                                  ...
                                  <option value="Bagmati" <?php if($row['state'] == "Bagmati"){echo "selected";}?>>Bagmati</option>
                                  <option value="Janakpur"<?php if($row['state'] == "Janakpur"){echo "selected";}?>>Janakpur</option>
                                </select>
                              </div>
                              <div class="mb-3 col-md-6">
                              ...
                              <div class="mb-3 col-md-6">
                                <label for="traffic_id" class="form-label">Traffic Id</label>
                                <input
                                  type="text"
                                  class="form-control"
                                  name="traffic"
                            ...
                            <div class="mt-2">
                              ...
                              <?php
                                ...
                                if($row['account_status'] == 1){
                                  ?>
                                  <button type="submit" name = "status" class="btn btn-danger me-2"> Disable </button>
                                  <?php
                                }

                                else{
                                  ?>
                                  <button type="submit" name = "status" class="btn btn-success me-2"> Enable </button>
