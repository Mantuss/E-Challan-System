                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel1"> Create Traffic Users</h5>
                            <button
                              type="button"
                              class="btn-close"
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row">
                              <div class="col mb-3">
                                ...
                                <input type="text" id="nameBasic" class="form-control" name="username" placeholder="Enter Name" />
                              </div>
                            </div>
                            <div class="row g-2 mb-3">
                              <div class="col mb-0">
                                <label for="emailBasic" class="form-label">Traffic_Id</label>
                                <input type="text" id="emailBasic" class="form-control" name="traffic_id" placeholder="xxxxxxxx" />
                              </div>
                              <div class="col mb-0">
                                <label for="dobBasic" class="form-label">Traffic_Post</label>
                                <input type="text" id="dobBasic" class="form-control" name="traffic_post" placeholder="Inspector General of Police" />
                              </div>
                            </div>
                            <div class="row">
                              <div class="col mb-3">
                                <label for="nameBasic" class="form-label">Passowrd</label>
                                <input type="password" id="nameBasic" class="form-control" name="password" placeholder="**********" />
                              </div>
                            </div>
                            <div class="row">
                              <div class="col">
                                <label for="nameBasic" class="form-label">Confirm Password</label>
                                <input type="password" id="nameBasic" class="form-control" name="confirm" placeholder="**********" />
                              </div>
                            </div>
                          </div>
                 ...
                 <div class="card-body">
                   <div class="table-responsive text-nowrap">
                     <table class="table table-bordered">
                       ...
                       <tbody>
                         <?php
                           $obj = new RequestRecovery();
                           $sql = "SELECT * FROM `requests` WHERE email != ''";
                           $result = $obj->getAccounts($sql);
                           while($row = mysqli_fetch_array($result)) {

                             $email = $row['email'];
                             $query = "SELECT * FROM `traffic_logs` WHERE email = '$email'";
                             $data = $obj->getAccounts($query);
